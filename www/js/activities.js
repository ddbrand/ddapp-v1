                        ...
                        var currentscore = $(this).attr('data-unitscore');
                            ...
                            if (currentname === unitname) {
                                ...
                                if (unitrank === 1) {
                                    ...
                                    $('.actunit[data-unitid="' + unitname + '"][data-unitscore="' + unitscore + '"] .item-after').html('<img src="img/Gold.svg" alt="Gold" style="width: 32px; height: 32px;" />');
                                } else if (unitrank === 2) {
                                    $('.actunit[data-unitid="' + unitname + '"][data-unitscore="' + unitscore + '"] .item-after').html('<img src="img/Silber.svg" alt="Silver" style="width: 32px; height: 32px;" />');
                                } else if (unitrank === 3) {
                                    $('.actunit[data-unitid="' + unitname + '"][data-unitscore="' + unitscore + '"] .item-after').html('<img src="img/Bronze.svg" alt="Bronze" style="width: 32px; height: 32px;" />');
                                }
                            } else {
                                console.log('N');
                            }
            ...
            if (data.success === false) {
                ...
                for (i = 0; i < data.value.length; i++) {
                    ...
                    $$('.activitiesset .actlist ul').append('<li>\n' +
                        '      <a href="/activities/highscore/" class="actunit item-link item-content"  data-shortdate="' + data.value[i].timeStampIso.split("T")[0] + '" data-unitscore="' + thisscore + '" data-unitid="' + unitname + '">\n' +
